...
var suo = {
        ...
        switch (e.type) {
            ...
            case "click":
                ...
                if (
                    ...
                    (ele.tagName.toLowerCase() != "html" && ele.parentNode.classList.contains("donate"))
                ) {
                    suo.donateBox.showDonate();
                }
    ...
    posMsgBox: function () {
        ...
        OBJ.style.left =
            (window.innerWidth -
                parseInt(window.getComputedStyle(OBJ).width.substr(0, window.getComputedStyle(OBJ).width.length - 2))) /
                2 +
            "px";
    },
    ...
    initMenu: function () {
        ...
        for (var i = 0; i < menuModel.main.length; i++) {
            menuP = suo.domCreate2(
                "div",
                {setName: ["className", "id"], setValue: ["menup", "m-" + menuModel.main[i]]},
                null,
                null,
        ...
        for (var i = 0; i < conf.options.settings.length; i++) {
            var _dom = suo.domCreate2("div"),
                ...
                _domLabel = suo.domCreate2(
                    "label",
                    {setName: ["className", "for"], setValue: ["box_radiooptionlabel", "box_radiooption_" + i + _time]},
                    null,
                    null,
                    null,
                    suo.getI18n(conf.options.settings[i].name)
        ...
        set_11: function () {
            ...
            for (var i = 1; i < menuModel.fn.length; i++) {
                var check = suo.domCreate2(
                    ...
                    "",
                    "",
                    {setName: ["conf0", "conf1", "confele"], setValue: ["normal", "fnswitch", "fn" + menuModel.fn[i]]}
                );
    ...
    initListItem: function (type) {
        ...
        if (type == "wges") {
            ...
            for (var i = 0; i < _doms.length; i++) {
                ...
                var _liName = suo.domCreate2(
                    "span",
                    {setName: ["className"], setValue: ["item_name item_edit edit_wges"]},
                    null,
                    "width:160px;",
        ...
        if (type == "ksa") {
            for (var i = 0; i < confOBJ.length; i++) {
                ...
                var liDel = suo.domCreate2(
                    "span",
                    {setName: ["className", "title"], setValue: ["item_del", suo.getI18n("tip_del")]},
                    null,
                    null,
                    null,
                    "x"
        ...
        for (var i = 0; i < confOBJ.length; i++) {
            ...
            var liName = suo.domCreate2(
                ...
                null,
                "",
                {setName: ["confid", "actiontype"], setValue: [i, actionType ? actionType : type]},
    ...
    itemEditDca: function (e) {
        ...
        if (
            !editMode ||
            e.target.classList.contains("box_text") ||
            e.target.classList.contains("box_note") ||
            e.target.classList.contains("box_destext")
        ) {
            return;
        }
        e.preventDefault();
    ...
    itemEditKsa: function (e, editType) {
        ...
        domTab.appendChild(
            suo.domCreate2(
                "span",
                {setName: ["className"], setValue: ["box_tabtitle box_tabtitleactive"]},
                null,
                null,
        ...
        let domTabListKeys = suo.domCreate2(
            "div",
            {setName: ["className"], setValue: ["box_tablist box_tablistkeys box_tablistactive"]},
            null,
            null,
            {setName: ["tab"], setValue: ["keys"]}
        );
        ...
        if (["txtengine", "imgengine", "script"].contains(actionType)) {
            ...
            if (actionType == "script") {
                domDes
                    .querySelector("ul")
                    .appendChild(
                        suo.domCreate2("li", "", null, null, null, "content: type or paste any code which you want.")
                    );
            } else {
                domDes
                    .querySelector("ul")
        ...
        if (direct) {
            ...
            for (var i = 0; i < direct.length; i++) {
                var dirimg = suo.domCreate2(
                    "img",
                    {setName: ["className", "src"], setValue: ["boxdirectimg", "../image/direct.png"]},
                    "",
    ...
    checkPermission: function (thepers, theorgs, theFunction, msg) {
        if (thepers && theorgs) {
            chrome.permissions.contains({permissions: thepers, origins: theorgs}, function (result) {
                checkPers(result);
            });
        } else if (thepers) {
        ...
        var getPers = function (thepers, theorgs) {
            ...
            chrome.runtime.sendMessage({
                type: "opt_getpers",
                value: {thepers: thepers, theorgs: theorgs, theFunction: theFunction, msg: msg},
            });
    ...
    initEnd: function () {
        ...
        chrome.browserSettings && chrome.browserSettings.contextMenuShowEvent
            ? chrome.browserSettings.contextMenuShowEvent.get({}).then(function (result) {
    ...
    initSizePos: function () {
        ...
        suo.cons.sizePos.btn_add_right =
            (window.innerWidth -
                Math.abs(
                    window.getComputedStyle(mainOBJ).width.substr(0, window.getComputedStyle(mainOBJ).width.length - 2)
                )) /
                2 -
            56 -
            20;
        ...
        window.setTimeout(function () {
            ...
            document.querySelector("#btn_add")
                ? (document.querySelector("#btn_add").style.cssText +=
                      "right:" + (suo.cons.sizePos.btn_add_right > 80 ? suo.cons.sizePos.btn_add_right : 80) + "px;")
                : null;
        }, 900);
        ...
        if (!dom.querySelector("#btn_add")) {
            dom.appendChild(
                suo.domCreate2(
                    ...
                    null,
                    null,
                    {setName: ["confobj", "actiontype"], setValue: [confobj, confobj.split("|")[0]]}
                )
            );
        }
        if (
    ...
    itemAddBefore: function (e) {
        ...
        if (confArray[1] == "ldrg") {
            testDom.textContent = "";
            testDom.appendChild(
                suo.domCreate2("a", {setName: ["href"], setValue: ["###"]}, null, null, null, suo.getI18n("test_ldrg"))
            );
    ...
    donateBox: {
        ...
        dom: function (items) {
            ...
            let initDom = function (itemOBJ, id) {
                ...
                var _list = suo.domCreate2(
                    "li",
                    {setName: ["className", "title"], setValue: ["donate_listli", itemOBJ.name]},
                    null,
                    null,
                    ...
                    case "cryptocurrency":
                        ...
                        for (var i = 0; i < itemOBJ.data.length; i++) {
                            ...
                            _cccontent.appendChild(
                                suo.domCreate2(
                                    "textarea",
                                    {setName: ["className", "readOnly"], setValue: ["donate_cctext", true]},
                                    null,
                                    null,
                                    {setName: ["id"], setValue: [i]},
            ...
            for (
                var i = 0;
                items.donate && items.donate[0] && items.donate[0].length > 0 && i < items.donate[0].length;
                i++
            ) {
        ...
        switchCcli: function (dom) {
            ...
            document
                .querySelector(".donate_ccdiv .donate_cccontent[data-id='" + dom.dataset.id + "']")
